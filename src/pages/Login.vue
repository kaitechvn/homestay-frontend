    ...
    <div class="container">
      <div class="row gy-3 align-items-center">
        ...
        <div class="col-12 col-md-6 col-xm-6 d-flex justify-content-center">
            <img src="@/assets/logo-login.png" alt="Description of image" class="img-fluid rounded-4" style="max-width: 83%; height: auto;">
        </div>
            ...
            <div class="card-body p-2 p-md-3 p-xl-3">
              ...
              <form @submit.prevent="login">
                <div class="row gy-2 overflow-hidden">
                  ...
                  <div class="col-12">
                    <div class="d-grid">
                      <button class="btn btn-primary btn-sm" type="submit">{{ t('login.log_in_now') }}</button>
                    </div>
                  </div>
                </div>
              </form>
              <div class="row">
                <div class="col-12">
                  <div class="d-flex gap-1 flex-column flex-md-row justify-content-md-end mt-3">
                    <router-link to="/forgot-password">{{ t('login.forgot_password') }}</router-link>
                  </div>
                </div>
              </div>
              <p class="text-end">{{ t('login.no_account') }} <router-link to="/register">{{ t('login.sign_up') }}</router-link></p>
              <div class="row">
                <div class="col-12">
                  <p class="mt-3 mb-3">{{ t('login.or_continue_with') }}</p>
                  <div class="d-flex gap-2 justify-content-center">
                    <a href="#!" class="btn btn-outline-danger btn-sm bsb-btn-circle">
                    ...
                    <a href="#!" class="btn btn-outline-primary btn-sm bsb-btn-circle">
